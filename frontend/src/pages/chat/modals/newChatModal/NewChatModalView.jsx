...
const NewChatModalView = (props) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-[#13111c]/80 flex items-center justify-center md:p-8 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="w-full md:max-w-2xl h-full md:h-auto md:max-h-[85vh] bg-base-200 md:rounded-2xl shadow-2xl border-none md:border border-base-200 flex flex-col overflow-hidden transition-all duration-300">
