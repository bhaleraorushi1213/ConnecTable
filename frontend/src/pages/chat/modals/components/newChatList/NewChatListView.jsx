...
const NewChatListView = (props) => {
  ...
  return (
    <>
      <div className="p-4 md:p-6 border-b border-base-200 flex items-center justify-between backdrop-blur sticky top-0 z-10">
        <button
          onClick={() => {
            setSearchQuery("");
      ...
      {/* search */}
      <div className="p-4 md:p-6 pb-2 bg-base-200">
        <div className="relative flex w-full items-center">
          <div className="absolute left-3 flex items-center pointer-events-none text-gray-400">
            <SearchIcon className="size-5" />
          </div>
          <input
            className="w-full h-10 pl-10 pr-4 rounded-xl bg-base-300 border-none text-base-content placeholder-gray-500 text-[17px] focus:ring-2 focus:ring-primary/50 transition-all shadow-sm"
      ...
      >
        <div className="px-4 py-2 space-y-1">
          <button
            ...
            className=" w-full flex items-center gap-3 p-3 rounded-xl hover:bg-base-300 transition-colors group text-left"
          >
        ...
        <div className="mt-4">
          ...
          {!searchQuery && (
            <div className="text-center py-12">
              ...
              <p className="text-base-content/60">Search for users to start a conversation</p>
            </div>
          )}
          ...
          {searchQuery && !isSearchLoading && !users?.length && (
            <div className="text-center py-12">
              <p className="text-base-content/60">No contacts found for "{searchQuery}"</p>
            </div>
          )}
            ...
            <div className="flex flex-col px-2 space-y-1">
              {users.map((contact) => (
                <button
                  ...
                  className="flex items-center gap-3 p-2 rounded-xl hover:bg-base-300 transition-colors w-full text-left group"
                >
                  {/* Avatar */}
                  ...
                  <div className="flex flex-col flex-1 min-w-0">
                    <p className="text-[17px] font-semibold text-base-content group-hover:text-primary transition-colors">
                      {contact.fullName}
                    </p>
                  ...
                  <span
                    className={`text-xs px-2 py-1 rounded-full ${onlineUsers.includes(contact?._id)
                      ...
                      : "bg-slate-800 text-base-content/60"
                      }`}
                  >
